...
public class HungryHungryHippos implements GameScene, GameControlScene {
     ...
     */
    Hippo lizzie = new Hippo("left", "Lizzie Hippo",  new Color(62, 12, 94));
    Hippo henry = new Hippo("up", "Henry Hippo",  Color.ORANGE);
    Hippo homer = new Hippo("down", "Homer Hippo",  Color.GREEN);
    Hippo harry = new Hippo("right", "Harry Hippo",  Color.YELLOW);
