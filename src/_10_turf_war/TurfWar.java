...
//            }
    ...
    public void setup() {
        ...
        background(new Color(100,100,100).getRGB());
        ...
        player1 = new Player(0,200,2,50,new Color(0,0,255).getRGB(),38,37,40,39);
        player2 = new Player(250,200,2,50,new Color(255,0,0).getRGB(),87,65,83,68);
    }
    /*
